#include "Classes1D/ExplicitSolvers1D/ExplicitSolvers1D.hpp"
   ...
   void ExplicitSolvers1D::Parameters_Stabilization
   (
...
// Stable_dt_Obj and Stable_DiffNumber are initialized with my inputs
 ...
 void ExplicitSolvers1D::Solve_nPlus1(const Field1D& Field1D_n_Obj,Field1D& Field1D_nPlus1_Obj , double Stable_Diffusion_Number_)
 {


      for (size_t i = 1; i < Field1D_n_Obj.Size() - 1 ; i++)
      {
        double RHS = Field1D_n_Obj.GetValue(i) 
        + Stable_Diffusion_Number_ * (Field1D_n_Obj.GetValue(i + 1) - 2.0 * Field1D_n_Obj.GetValue(i) 
        + Field1D_n_Obj.GetValue(i -1));
...
void ExplicitSolvers1D::Solve_nPlus1(Field1D& Field1D_n_Obj,Field1D& Field1D_nminus1_Obj,Field1D& Field1D_nplus1_Obj,std::vector<double> CoeffsVector_)
  {
  ...
  std::vector<double> ExplicitSolvers1D::ReturnDuFortFrankelCoeffs(const SolutionParameters<double>& My_Diff_Number_Obj)
   {
